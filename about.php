<?php include 'includes/header.php'; ?>
			...
			<div class="row">
				...
				<div class="col-lg-7 right-img-w3ls pl-lg-4 mt-lg-2 mt-4">
					<div class="bott-w3ls mr-xl-5">
						<h3 class="title-w3 text-bl mb-3 font-weight-bold">Some of Company Achivements</h3>
	...
	<section class="team bg-li py-5" id="team">
		<div class="container py-xl-5 py-lg-3">
			...
			<p class="sub-tittle text-center mt-3 mb-sm-5 mb-4">We are very happy to doing this project with the team members .. </p>
			<div class="row ab-info second pt-lg-4">
				<div class="col-lg-4 col-sm-6 ab-content text-center mt-lg-0 mt-4 p-2">
					<div class="ab-content-inner">
						<img src="images/t3.jpg" alt="news image" class="img-fluid">
						<div class="ab-info-con">
							<h4 class="text-team-w3">Indrani Mondal</h4>
							<p class="sub-tittle text-center mt-3 mb-sm-5 mb-4">Team Leader </p>
				...
				<div class="col-lg-4 col-sm-6 ab-content text-center mt-lg-0 mt-4 p-2">
					<div class="ab-content-inner">
						...
						<div class="ab-info-con">
							<h4 class="text-team-w3">Deb Kaiti</h4>
							<p class="sub-tittle text-center mt-3 mb-sm-5 mb-4">Team Member </p>
							<ul class="list-unstyled team-socil-w3pvts">
				...
				<div class="col-lg-4 col-sm-6 ab-content text-center mt-lg-0 mt-4 p-2">
					<div class="ab-content-inner">
						<img src="images/t1.jpg" alt="news image" class="img-fluid">
						<div class="ab-info-con">
							<h4 class="text-team-w3">Rakesh Singha</h4>
							<p class="sub-tittle text-center mt-3 mb-sm-5 mb-4">Team Member </p>
				...
				<div class="col-lg-4 col-sm-6 ab-content text-center mt-lg-0 mt-4 p-2">
					<div class="ab-content-inner">
						<img src="images/t1.jpg" alt="news image" class="img-fluid">
						<div class="ab-info-con">
							<h4 class="text-team-w3">Sumongol Dey</h4>
							<p class="sub-tittle text-center mt-3 mb-sm-5 mb-4">Team Member </p>
				...
				<div class="col-lg-4 col-sm-6 ab-content text-center mt-lg-0 mt-4 p-2">
					<div class="ab-content-inner">
						...
						<div class="ab-info-con">
							<h4 class="text-team-w3">Tufan Chowdhury</h4>
							<p class="sub-tittle text-center mt-3 mb-sm-5 mb-4">Team Member</p>
				...
				<div class="col-lg-4 col-sm-6 ab-content text-center mt-lg-0 mt-4 p-2">
					<div class="ab-content-inner">
						<img src="images/t1.jpg" alt="news image" class="img-fluid">
						<div class="ab-info-con">
							<h4 class="text-team-w3">Pramit Nandi</h4>
							<p class="sub-tittle text-center mt-3 mb-sm-5 mb-4">Team Member </p>
